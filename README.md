 ...
 * On mobile devices, your app can be added directly to the user's common screen, app icon and all. You can also re-engage users using web **push notifications**. This eliminates the need for the app store.
